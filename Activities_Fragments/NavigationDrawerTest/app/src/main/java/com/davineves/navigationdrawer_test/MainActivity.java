package com.davineves.navigationdrawer_test;

import android.os.Bundle;

import com.davineves.navigationdrawer_test.ui.home.HomeFragment;
import com.davineves.navigationdrawer_test.ui.home.HomeViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    //Teste para o Model do Fragment Home
    private String testeHome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Configurando fragment genérico com FrameLayout no app_bar_main.xml
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Teste da Snackbar", Snackbar.LENGTH_LONG)
        ...
        //Teste do Model da Home
            /*HomeViewModel homeViewModel = new HomeViewModel();
            homeViewModel.getText();*/

        //Novo onNavigationItemSelected (manipular ao entrar nos fragments da NavigationBar)
